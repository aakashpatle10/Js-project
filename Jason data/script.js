const users = [
  ...
  users.forEach(function(e){
    sum = sum + `
    <div class="card">
         <img class="cover" src="${e.coverPhoto}" alt="">
         <div class="second" >
             <img class="profile" src="${e.profilePhoto}" alt="" />
             <h1 class="user">${e.username}</h1>
             <h4 class="name">${e.fullName}</h4>
             <p>${e.description}</p>
             <div class="linep">
                 <div class="line"></div>
             </div>
         ...
         <div class="in">
             <div class="media">
               <h4>${e.mediaUploadedCount}</h4>
               <p class="gen">Media</p>
             </div>
             <div class="follower">
               <h4>${e.followersCount}</h4>
               <p class="gen">Followers</p>
             </div>
             <div class="following">
               <h4>${e.followingCount}</h4>
               <p class="gen">Following</p>
             </div>
         </div>
